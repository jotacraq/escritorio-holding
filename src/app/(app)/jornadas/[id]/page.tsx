...
export default function PaginaFicha360({ params }: { params: Promise<{ id: string }> }) {
  ...
  const abas: DefinicaoAba[] = [
    ...
    { id: "briefing", rotulo: "Briefing", grupo: "Preparação", conteudo: <BriefingAba jornadaId={id} briefingAtualId={ficha.briefingAtual?.id ?? null} /> },
  ...
  if (podeVerPatrimonio) {
    ...
    abas.push({ id: "croqui", rotulo: "Croqui", grupo: "Patrimônio", conteudo: <CroquiAba jornadaId={id} timeline={ficha.timeline} /> });
  }
