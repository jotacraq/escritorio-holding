...
const RASCUNHO_EXEMPLO_BRIEFING: Briefing = {
  ...
  processo_decisorio: {
    velocidade: "Exemplo fixo de demonstração",
    necessidade_seguranca: "Exemplo fixo de demonstração",
    necessidade_validacao: "Exemplo fixo de demonstração",
    necessidade_detalhe: "Exemplo fixo de demonstração",
  ...
  estrategia_sessao: {
    ritmo: "Exemplo fixo de demonstração",
